...
namespace Testing
{
    public class RotorNotMVVM
    {
        ...
        public RotorNotMVVM Prev { get; set; }

        public RotorNotMVVM Next { get; set; }
        ...
        #endregion
        //+
        public RotorNotMVVM(string chars)
        {
        ...
        {
            if (this.Current == this.Turnover)// && this.Type == Type.RotorNotMVVM)
                this.Prev.Rotate();
            if (this.IsFirst)
                this.Rotate();
